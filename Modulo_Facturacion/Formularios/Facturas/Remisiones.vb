    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        Try
            ...
            If String.IsNullOrWhiteSpace(txtNumRemision.Text) Then
                If MessageBox.Show("Registrar nueva remisión ¿Esta seguro?", "Control de Remisión", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
                ...
                End If
            Else
                If MessageBox.Show("Se Actualizara esta remision ¿Esta seguro?", "Control de Remisión", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
                        Dim estado As Boolean = DataGridDetalleCuotas.SelectedCells.Item(4).Value 'Obtenemos el estado de pago de la cuota
                        If estado = True Then
...
#Region "Funciones "
    ...
    Private Function ValidacionDeCampos() As Boolean
        Try
            ...
            Dim DocumFormado As String = txtIdentificacion.Text & "-" & txtDigiVeri.Text
            Dim query As String = "SELECT COUNT(*) TolUsua FROM [ADYSNET].[dbo].[CMDTERCEROS] WHERE  [CMDIdentificadorUnoTerceros] =  '" & DocumFormado & "' AND [CMDSucursalTerceros] =  '" & txtSucursal.Text & "'"
            ...
            If ContaTercero.HasRows Then
                ...
                If Convert.ToInt32(ContaTercero("TolUsua")) <= 0 Then
                    Titulo01 = "Control de validaciones cuentas contables"
                    Informa = "Lo siento pero no se encontro el tercero en contabilidad con numero de documento " & DocumFormado & " Y sucursal " & txtSucursal.Text & "," & Chr(13) & Chr(10)
